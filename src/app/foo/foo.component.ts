...
export class FooComponent {
  ...
  makeRequest(): void {
    ...
    this.o = this.http.get('https://my-json-server.typicode.com/FrancoDiego21/redditAngular/articles');
  ...
  getData = (d : Object) =>
  {
   ...
   makeCompactRequest(): void {
    this.loading = true;
    this.http
      .get('https://my-json-server.typicode.com/FrancoDiego21/redditAngular/articles')
      .subscribe(d => {
        this.dataGet = d;
        this.loading = false;
        document.getElementById("res-get").style.display = "block";
   ...
   makeTypedRequest() : void
   {
     ...
     this.oArticles = this.http.get<Articles[]>('https://my-json-server.typicode.com/FrancoDiego21/redditAngular/articles');
     this.oArticles.subscribe(d => {this.articleData = d;});
   }  
  ...
  makeCompactPost(): void {
    this.loading = true;
    this.http
      .post('https://my-json-server.typicode.com/FrancoDiego21/redditAngular/articles',
        JSON.stringify({
          "id": 2,
